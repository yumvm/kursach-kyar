$(document).ready(function(){ 
    ...
    // AJAX-запрос к XML-файлу для загрузки данных об овощах
    $.ajax({
        ...
        success: function(xml) { // Если загрузка успешна, выполняем этот код
            // Находим все <product> внутри категории с type="Vegetables"
            $(xml).find('Category[type="Vegetables"] > product').each(function(){
