$(document).ready(function(){
    ...
    // AJAX-запрос к XML-файлу для загрузки данных о фруктах
    $.ajax({
        ...
        success: function(xml) { // Если загрузка успешна, выполняем этот код
            // Находим все <product> внутри категории с type="Fruits"
            $(xml).find('Category[type="Fruits"] > product').each(function(){
